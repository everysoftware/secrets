...
from app.core.models import User, Record, Comment
from .schemes import RecordCreate, RecordRead, RecordUpdate, RecordsRead
...
@router.get("/{id}", response_model=RecordRead, responses={
...
@router.patch("/{id}", response_model=RecordRead, responses={
    404: {"description": "Record not found"},
    403: {"description": "Not enough rights"}
})

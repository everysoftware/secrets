...
from domain.schemes.base import Params, Page
from domain.schemes.transfer import PasswordItem
    ...
    async def search(
        ...
        *,
        ...
        for item in page.items:
            item.username = aes.decrypt(
                item.username, settings.infrastructure.encryption.secret
            )

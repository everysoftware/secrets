...
from api.auth.schemes import User as UserScheme
from bot.commands import BOT_COMMANDS_STR
from bot.fsm import LoginGroup, RegisterGroup
from bot.keyboards.auth import AUTH_KB, REG_KB

...
from domain.password import PasswordCreate, PasswordRead, PasswordUpdate, PasswordItem
...
@router.post("", response_model=PasswordRead, status_code=status.HTTP_201_CREATED)
...
async def get_password(
        password: PasswordRead = Depends(valid_password),
):
    return password

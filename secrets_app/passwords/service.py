...
from secrets_app.core.service import Service
from secrets_app.passwords.encryption import PasswordEncryption
...
from secrets_app.schemas import PageParams
...
class PasswordService(Service):
    ...
    async def update(self, password_id: int, update: SPasswordUpdate) -> SPassword:
